...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "BudgefiCapacitorSystemSession", path: "../../../packages/capacitor-system-session"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "BudgefiCapacitorSystemSession", package: "BudgefiCapacitorSystemSession"),
